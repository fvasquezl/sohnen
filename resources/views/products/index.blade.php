        ...
        $('#CategoryID').on('change', function() {
         ...
         $(document).on('click', '.quote-btn', function(e) {
             ...
             if (!percentOfRetail) {
                 ...
                 let url = `/quotations`;
                 let method = 'POST';
                 $form.append(`<input type="hidden" name="SKU" value="${product.SKU}">`);
                 $form.append(`<input type="hidden" name="Qty" value="1">`);
                 $form.append(`<input type="hidden" name="Condition" value="B">`);
                 $form.append(`<input type="hidden" name="PercentOfRetail" value="${percentOfRetail}">`);
                 $form.append(`<input type="hidden" name="SalePrice" value="${product.EstimatedRetail}">`);
                 $form.append(`<input type="hidden" name="CustomerName" value="${customerName}">`);
                 $form.append(`<input type="hidden" name="Description" value="${product.Description}">`);
                saveQuotation(url, method, $form);
             }
             // else{
